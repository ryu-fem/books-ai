...
def _detect_grade_from_text(text: str) -> str:
    ...
    # إشارة إن الكلام عن المرحلة الثانوية: إما كلمة "ثانوي" صريحة، أو
    # كلمة "بكالوريا"/"مش بكالوريا" (كتير بيكتفوا بيها من غير "ثانوي")
    secondary_signal = "ثانو" in t or "بكالوريا" in t or "بكالوريه" in t
...
_SUBJECT_KEYWORDS = [
    ("انجليزي", ["انجليزي", "انجليزى", "انجلش", "انجلشاوي", "english"]),
    ("فرنساوي", ["فرنساوي", "فرنساوى", "فرنسي", "لغه فرنسيه", "french"]),
    ("الماني", ["الماني", "الالمانيه", "german"]),
    ("عربي", ["عربي", "عربى", "لغه عربيه", "نصوص", "قواعد النحو", "بلاغه"]),
    ("فيزياء", ["فيزياء", "فيزيا"]),
    ("كيمياء", ["كيمياء", "كيميا"]),
    ("احياء", ["احياء", "الاحياء"]),
